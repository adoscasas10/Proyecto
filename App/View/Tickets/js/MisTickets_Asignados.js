$(document).ready(function () {
    ...
    var dataTable = $('#ticket_asignado_data').DataTable({
        "pageLength": 5,
        ...
        "buttons": [
            ...
            },
            {
                extend: 'pdfHtml5',
                text: 'Exportar PDF',
                title: 'Reporte de Tickets Asignados',
                orientation: 'landscape',
                pageSize: 'A4',
                exportOptions: {
                    // Excluir la última columna (la de "Opciones")
                    columns: function (idx, data, node) {
                        const totalCols = $('#ticket_asignado_data thead th').length;
                ...
                customize: function (doc) {
                    ...
                    doc.content.splice(0, 1, {
                        text: 'Reporte de Tickets Asignados',
                        fontSize: 18,
                        alignment: 'center',
                        margin: [0, 0, 0, 20],
                        bold: true,
    ...
    $('#filtroEstadoSistema').on('change', function () {
        const estado = $(this).val(); // Habilitado, Deshabilitado o vacío
        ...
        // $.ajax({
        //     url: 'tu_ruta/listarUsuarios.php',
        //     type: 'POST',
        //     dataType: 'json',
...
function generarCardsDesdeDataTable() {
    const table = $('#ticket_asignado_data').DataTable();
...
$(document).ready(function () {
    ...
    const table = $('#ticket_asignado_data').DataTable(); // no reconfigures aquí
    ...
    function moverPaginador() {
        $('#ticket_asignado_data_paginate').detach().appendTo('#paginadorExtra');
    }
